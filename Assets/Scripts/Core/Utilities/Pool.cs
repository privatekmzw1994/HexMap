...
namespace Core.Utilities
{
    public class Pool<T>
    {
        ...
        /// <summary>
        /// Create a new pool with a num of initial elements
        /// </summary>
        ...
        /// <param name="initialCapacity">initialCapacity of the pool</param>
