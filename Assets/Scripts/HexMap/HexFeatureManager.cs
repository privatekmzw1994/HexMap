...
public class HexFeatureManager : MonoBehaviour
{
    ...
    public Transform wallTower,bridge;//墙塔

    public Transform[] special;//特殊地标
    ...
    void AddWallSegment(Vector3 nearLeft, Vector3 farLeft, Vector3 nearRight, Vector3 farRight,bool addTower = false)
    {
        ...
        v3.y = leftTop;
        v4.y = rightTop;
        walls.AddQuadUnperturbed(v1, v2, v3, v4);//单面墙
        ...
        v3.y = leftTop;
        v4.y = rightTop;
        walls.AddQuadUnperturbed(v2, v1, v4, v3);//双面墙

        walls.AddQuadUnperturbed(t1, t2, v3, v4);//围墙上侧
