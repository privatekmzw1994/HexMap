...
namespace TowerDefense.Wave
{
    ...
    public class WaveSpawnManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Whether the WaveManager starts waves on Awake - defaulted to null since the WaveManager should call this function
        /// </summary>
        ...
        public virtual void StartWaves()
        {
            ...
            {
                Debug.LogWarning("[WAVE] No Waves on wave spawn manager. Calling spawningCompleted");
